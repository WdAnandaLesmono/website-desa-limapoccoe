...
<body>
    ...
    <div class="container create-new-post col-7 mt-5 px-5 py-5">
        <h5 class="text-center mb-5" style="color: #365E32">Edit Berita</h5>
        <form action="/admin/{{ $berita->id }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-5">
                ...
                <input type="text" class="form-control" id="img_description" name="img_description" autofocus required
                    value="{{ old('img_description', $berita->img_description) }}">
            </div>
            <div class="mb-5">
                <label for="body" class="form-label">Isi</label>
                <input id="body" type="hidden" name="body" autofocus required
